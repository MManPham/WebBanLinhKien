...
<body>
    <div id="container">
        <header>
            ...
            <div style="height: 100%; width: 21%;  height: 150px; ">
                <div class="feildBasic">
                    ...
                    <?php 
                    include_once("View/View_getData/hienthiGioHang.php");?>
                </div>
            </div>
            <p class="clear"></p>
        </header>
        ...
        <article>
            ...
            <section id="gioHang" class="feildContent">
                 <?php include_once("View/View_getData/hienThiPageGH.php");?>
            </section>
        </article>
        <aside>
            <div id="Search"/>
    ...
    <script src="Model/gioHang.js" ></script>
    <?php include_once('Model/autoComplete_Search.php');?>
    <!--Main Script page -->
      <script>
        $('.ddcolortabs').attr('id','');
        $('#TongGia').text($('#soTien').text()+"đ");
